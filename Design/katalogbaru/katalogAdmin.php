      ...
      <div class="sidebar">
        <div class="user-profile">
          ...
          <div class="info-wrapper">
            <p class="user-name">Ihya Reza Mufti</p>
            <h6 class="display-income">Rp. 3,400,00</h6>
          </div>
        </div>
          ...
          <div class="content-viewport">
            <div class="row">
              <div class="col-lg-6 equel-grid">
                <div class="grid">
                  <p class="grid-header">Tambah Katalog</p>
                  <div class="grid-body">
                    <div class="item-wrapper">
                      <form action="createAksi.php" method="post">
                      <div class="card shadow radius">
                            <div class="card-img">
                                <img src="https://www.sewakost.com/files/12-2017/ad16169/kost-premium-dekat-ui-1438788801_large.jpg"
                                    class="card-img-top shadow radius" alt="...">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title font-weight-bold"><button class="btn btn-primary">Kost Area </button>
                                    sisa 2 kamar</h5>
                                <h3 class="font-weight-bold">Rp 1.250.000 / bulan</h3>
                                <h6 class="font-weight-bold color-gray">Cluster Tidar (Block C1)</h6>
                            </div>
                        </div>
                ...
                -->
                          <!-- <input type="file" class="form-control" id="inputEmail1" placeholder="Choose your file"> -->
                 <!--         <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
                        ...
                        <div class="form-group">
                          <label for="inputPassword1">Kategori Kamar</label>
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control"  placeholder="Sisa Kamar">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="inputPassword1">Nama Kos</label>
                          <input type="text" class="form-control"  placeholder="Nama Kos">
                        </div>
...
$("#imgInp").change(function() {
  readURL(this);
            ...
            -->
              ...
              <div class="col-lg-6 equel-grid">
                <div class="grid">
                  <p class="grid-header;tombol" href="c">Tambah Katalog</p>
                  <div class="grid-body">
                    <div class="item-wrapper">
                    <div class="card shadow radius">
                            <div class="card-img">
                            ...
                            <div class="card-body">
                                <h5 class="card-title font-weight-bold"><button class="btn btn-primary">kontrakan</button>
                                    sisa 2 kamar</h5>
                                <h3 class="font-weight-bold">Rp 1.250.000 / bulan</h3>
                                <h6 class="font-weight-bold color-gray">Cluster Tidar (Block C1)</h6>
                            </div>
                        ...
                        <div class="card shadow radius">
                            ...
                            <div class="card-body">
                                <h5 class="card-title font-weight-bold"><button class="btn btn-primary">.....</button>
                                    .....</h5>
                                <h3 class="font-weight-bold">Rp ..... / .....</h3>
                                <h6 class="font-weight-bold color-gray">.....</h6>
                            </div>
                        </div>
          <!--
                      <form>
